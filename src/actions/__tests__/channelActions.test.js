...
describe("channel actions", () => {
  ...
  it("should add a channel", () => {
    ...
    const channelId = store.dispatch(actions.addChannel(denormImageChannel1Import));
  ...
  it("should not create a channel without sampleRate", () => {
    ...
    const channelId = store.dispatch(actions.addChannel(denormImageChannel1WithoutSampleRate));
  ...
  it("should create an empty image channel", () => {
    ...
    const channelId = store.dispatch(actions.createImageChannel());
    expect(channelId).toEqual(imageChannel1.channelId);
    const acts = store.getActions();
    expect(acts).toEqual(expectedActions);
  });
  ...
  it("should delete a channel", () => {
    ...
    store.dispatch(actions.deleteChannel(imageChannel1.channelId));
    const acts = store.getActions();
    expect(acts).toEqual(expectedActions);
